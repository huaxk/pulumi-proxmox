...
func NewLXCContainer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("proxmox:index/lXCContainer:LXCContainer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLXCContainer(ctx *pulumi.Context,
	...
	var resource LXCContainer
	err := ctx.ReadResource("proxmox:index/lXCContainer:LXCContainer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
